...
func (x *MenuResponse) GetItems() []*Item {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_coffee_shop_proto_rawDesc = "" +
	...
	"\vMenuRequest\"7\n" +
	"\fMenuResponse\x12'\n" +
	"\x05items\x18\x01 \x03(\v2\x11.coffee_shop.ItemR\x05items\"0\n" +
	"\x05Order\x12'\n" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\xd5\x01\n" +
	"\x11CoffeeShopService\x12B\n" +
	"\aGetMenu\x12\x18.coffee_shop.MenuRequest\x1a\x19.coffee_shop.MenuResponse\"\x000\x01\x128\n" +
	"\n" +
	"PlaceOrder\x12\x12.coffee_shop.Order\x1a\x14.coffee_shop.Receipt\"\x00\x12B\n" +
	"\x0eGetOrderStatus\x12\x14.coffee_shop.Receipt\x1a\x18.coffee_shop.OrderStatus\"\x00B\x15Z\x13coffee_shop_protos/b\x06proto3"
...
var file_coffee_shop_proto_goTypes = []any{
	...
	(*Order)(nil),        // 2: coffee_shop.Order
	(*Receipt)(nil),      // 3: coffee_shop.Receipt
	(*OrderStatus)(nil),  // 4: coffee_shop.OrderStatus
	(*Item)(nil),         // 5: coffee_shop.Item
}
var file_coffee_shop_proto_depIdxs = []int32{
	5, // 0: coffee_shop.MenuResponse.items:type_name -> coffee_shop.Item
	5, // 1: coffee_shop.Order.items:type_name -> coffee_shop.Item
	0, // 2: coffee_shop.CoffeeShopService.GetMenu:input_type -> coffee_shop.MenuRequest
	2, // 3: coffee_shop.CoffeeShopService.PlaceOrder:input_type -> coffee_shop.Order
	3, // 4: coffee_shop.CoffeeShopService.GetOrderStatus:input_type -> coffee_shop.Receipt
	1, // 5: coffee_shop.CoffeeShopService.GetMenu:output_type -> coffee_shop.MenuResponse
	3, // 6: coffee_shop.CoffeeShopService.PlaceOrder:output_type -> coffee_shop.Receipt
	4, // 7: coffee_shop.CoffeeShopService.GetOrderStatus:output_type -> coffee_shop.OrderStatus
